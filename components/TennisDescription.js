...
function TennisDescription({ sidebarTennis }) {
    return (
        <div className={sidebarTennis ? 'sidebar__left active' : 'sidebar__left'}>
            <h1 className="sidebar__left__header">Tennis Career</h1>
            ...
            <div className="sidebar__left__image">
                <Image src={joaoMurray2} className="sidebar__left__image__image" fill />
            </div>
        </div>
    )
}
